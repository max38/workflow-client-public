...
import { Form, Icon, Switch, Input, Select, Row, Col, Tabs, Button } from 'UIKit';
...
export default class ConditionalEventProperty extends Component {
  constructor(props) {
    super(props);
    ...
    if (props.currentElement) {
      ...
      if(currentElement.$attrs){
        ...
        this.state.check_after_processing = (currentElement.$attrs.check_after_processing == "true");
    ...
    if (currentElement) {
      ...
      if(currentElement.$attrs){
        ...
        this.setState({
          ...
          check_after_processing: (currentElement.$attrs.check_after_processing == "true"),
        });
      }
    }
  }
  ...
  updateByBpmnProperty(nodeId, newProps){
    ...
    if(condition_script_type != '-' && (!name || !name.includes("Condition"))){
      name = "Condition - " + name;
      newProps.name = name;
    }
  ...
  onAfterProcessingChange(value, event){
    let { nodeId } = this.state;
    
    this.setState({
      check_after_processing: value,
    });
  ...
  render() {
    ...
    let { nodeName, nodeId, currentElement, condition_script_type, condition_script_info, check_after_processing } = this.state;
    ...
    if(condition_script_type == "expression"){
      input_condition_element = <Form.Item
          ...
          <Input value={condition_script_info} />
      </Form.Item>
    }else if(condition_script_type == "python"){
      input_condition_element = <Form.Item
          label={
      ...
      <Tabs type="card">
        ...
        <Row >
            ...
            <Form
              ...
              name="basic"
            >
              {this.props.isBoundary && <Form.Item
                label={
                  <span>
                    After Processing&nbsp;
                  </span>
              ...
              >
                <Switch
                  checked={check_after_processing}
                  onChange={this.onAfterProcessingChange.bind(this)}
